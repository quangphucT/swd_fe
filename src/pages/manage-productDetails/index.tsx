...
const ManageProductDetails = () => {
    ...
    const formItem = <>
        ...
        {/* product description */}
        <Form.Item label="ProductDescription" name={"productDescription"} rules={[{
            required: true,
        ...
        {/* ingredient */}
        <Form.Item label="Ingredient" name={"ingredient"} rules={[{
            required: true,
        ...
        {/* effect */}
        <Form.Item label="Effect" name={"effect"} rules={[{
            required: true,
        ...
        <Form.Item label="How To Use" name={"howToUse"} rules={[{
            required: true,
        ...
        {/* sideEffect */}
        <Form.Item label="SideEffect" name={"sideEffect"} rules={[{
            required: true,
    ...
    {/* note */}
        ...
        {/* preserve */}
        <Form.Item label="Preserve" name={"preserve"} rules={[{
            required: true,
    ...
    return (
        <div>
            <DashboardTemplate formItem={formItem} titleModal="ProductDetails Information" titleModalUpdate="Update information" createName="Add productDetails" titleTable="ProductDetails Management" apiURI="ProductDetails" columns={columns} />
        </div>
    )
}
