...
const ManageProduct = () => {
    ...
    const formItem = <>
        ...
        <Form.Item name={"price"} label="Product price" rules={[{
            required: true,
        ...
        <Form.Item
            ...
            name="manufacturerId"
            rules={[{ required: true, message: "Manufacturer must not be blank!!" }]}
        >
            <Select>
        ...
        <Form.Item
            ...
            rules={[{ required: true, message: "ManufacturedCountry must not be blank!!" }]}
        >
            <Select>
        ...
        <Form.Item
            ...
            rules={[{ required: true, message: "ProductDetails ID must not be blank!!" }]}
        >
            <Select>
    ...
    return (
        <div>
            <DashboardTemplate formItem={formItem} createName="Create new product" titleModal="Add new product" titleModalUpdate="Update product information" titleTable="Product Management" apiURI="Products" columns={columns} />
        </div>
    )
}
